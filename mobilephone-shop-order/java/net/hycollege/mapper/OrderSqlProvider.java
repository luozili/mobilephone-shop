...
import net.hycollege.mybatis.domain.OrderExample.Criteria;
import net.hycollege.mybatis.domain.OrderExample.Criterion;
...
public class OrderSqlProvider {
    ...
    public String insertSelective(Order record) {
        ...
        if (record.getGmtPayment() != null) {
            sql.VALUES("gmt_payment", "#{gmtPayment,jdbcType=VARCHAR}");
        }
        
        if (record.getTotalAmount() != null) {
            sql.VALUES("total_amount", "#{totalAmount,jdbcType=REAL}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getGmtPayment() != null) {
            sql.SET("gmt_payment = #{record.gmtPayment,jdbcType=VARCHAR}");
        }
        
        if (record.getTotalAmount() != null) {
            sql.SET("total_amount = #{record.totalAmount,jdbcType=REAL}");
        }
    ...
    public String updateByPrimaryKeySelective(Order record) {
        ...
        if (record.getGmtPayment() != null) {
            sql.SET("gmt_payment = #{gmtPayment,jdbcType=VARCHAR}");
        }
        
        if (record.getTotalAmount() != null) {
            sql.SET("total_amount = #{totalAmount,jdbcType=REAL}");
        }
