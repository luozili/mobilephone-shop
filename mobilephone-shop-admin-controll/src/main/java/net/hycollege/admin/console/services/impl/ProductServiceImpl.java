...
public class ProductServiceImpl implements ProductService {
	...
	public void addProduct(Product product, String pdesc, ESProduct esProduct) {
		...
		try {
			...
			restTemplate.postForObject("http://47.103.217.104:8084/product/add", requestEntity, Message.class);
		} catch (Exception e) {
	...
	public ProductMessage selectOneProduct(String productID) {
		try {
			return restTemplate.getForObject("http://47.103.217.104:8084/product/get?productID=" + productID,
	...
	public Message deleteOneProduct(String productID) {
		try {
			...
			return restTemplate.postForObject("http://47.103.217.104:8084/product/delete", requestEntity, Message.class);
		} catch (Exception e) {
			System.out.println(e);
	...
	public Message updateOneProduct(ProductMessage productMessage, ESProduct esProduct) {
		try {
			...
			HttpEntity<String> requestEntity = new HttpEntity<String>(
					objectMapper.writeValueAsString(productMessageAndESProduct), headers);
			return restTemplate.postForObject("http://47.103.217.104:8084/product/update", requestEntity, Message.class);
		} catch (Exception e) {
			System.out.println(e);
			return new Message(Message.fail);
		}
	...
	public Message updateOneProductStatus(String productID, String status) {
		try {
			...
			HttpEntity<MultiValueMap<String, String>> requestEntity = new HttpEntity<MultiValueMap<String, String>>(
					postParameters, headers);
			return restTemplate.postForObject("http://47.103.217.104:8084/product/update/status", requestEntity,
					Message.class);
		} catch (Exception e) {
			System.out.println(e);
			return new Message(Message.fail);
	...
	public LayUITableMessage getProducts(int currentPage, int pageSize) {
		try {
			return restTemplate.getForObject(
					"http://47.103.217.104:8084/product/gets?currentPage=" + currentPage + "&pageSize=1" + pageSize,
