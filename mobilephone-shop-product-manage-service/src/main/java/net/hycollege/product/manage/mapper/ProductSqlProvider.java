...
import net.hycollege.mybatis.domain.ProductExample.Criteria;
import net.hycollege.mybatis.domain.ProductExample.Criterion;
...
public class ProductSqlProvider {
    ...
    public String insertSelective(Product record) {
        ...
        if (record.getPrices() != null) {
            sql.VALUES("prices", "#{prices,jdbcType=REAL}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getPrices() != null) {
            sql.SET("prices = #{record.prices,jdbcType=REAL}");
        }
    ...
    public String updateByPrimaryKeySelective(Product record) {
        ...
        if (record.getPrices() != null) {
            sql.SET("prices = #{prices,jdbcType=REAL}");
        }
        
        sql.WHERE("pid = #{pid,jdbcType=VARCHAR}");
