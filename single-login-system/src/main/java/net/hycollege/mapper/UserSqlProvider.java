...
import net.hycollege.mybatis.domain.UserExample.Criterion;
...
public class UserSqlProvider {
    ...
    public String insertSelective(User record) {
        ...
        if (record.getRecieve() != null) {
            sql.VALUES("recieve", "#{recieve,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getRecieve() != null) {
            sql.SET("recieve = #{record.recieve,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(User record) {
        ...
        if (record.getRecieve() != null) {
            sql.SET("recieve = #{recieve,jdbcType=VARCHAR}");
        }
